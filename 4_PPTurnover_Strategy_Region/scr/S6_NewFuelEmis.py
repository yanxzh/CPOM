...
def new_fuel_emis(isec,ifa,ireg,NewProdDistr_dir,NewFuelEmis_dir,yr_beg,yr_end):
    ...
    final_df = prod.melt(id_vars=['Fake_Plant ID', 'Plant ID', 'Country','Start Year'], var_name='Year', value_name='Production')
...
def pp_combine(isec,ifa,ireg,OldProdEmis_dir,CCSInstall_dir,yr_beg,yr_end,new_pp):
...
#%%
def NewFuelEmis_main(ieng_sc,iend_sc,ior_sc,isec,ifa,ireg,NewProdDistr_dir,OldProdEmis_dir,NewFuelEmis_dir,CCSInstall_dir,yr_beg,yr_end):
    ...
    all_pp = pp_combine(isec,ifa,ireg,OldProdEmis_dir,CCSInstall_dir,yr_beg,yr_end,new_pp)
