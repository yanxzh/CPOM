...
#%%
def Old_ProdEmis(isec,ifa,ireg,pp,Turnover_dir,yr_beg,yr_end,yearls2):
    ...
    scale_cf = scale_cf.melt(id_vars=['Plant ID'], var_name='Year', value_name='CF_SF')
...
def Old_ProdEmis_main(ieng_sc,iend_sc,ior_sc,isec,ifa,ireg,Turnover_dir,OldProdEmis_dir,CCSInstall_dir,yr_beg,yr_end):
    ...
    pp_this_period = Old_ProdEmis(isec=isec,ifa=ifa,ireg=ireg,pp=pp_file,Turnover_dir=Turnover_dir,yr_beg=yr_beg,yr_end=yr_end,yearls2=yearls2)
